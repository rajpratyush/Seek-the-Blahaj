...
const { isChair } = require("../lib/example_helper");
...
module.exports = async function (helper) {
  ...
  if (!answer1 || !isChair(answer1)) {
    return helper.fail(`
      The answer to the first question is incorrect. The answer you are looking for begins with 'c'.
    `);
  }
